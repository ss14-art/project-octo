...
description: Prototype localization and Resources layout guidance for SS14-ART-CORE. Use when adding player-visible prototypes, markings, reagents, guidebook entries, entity names/descriptions, or localized resource data.
---
...
- New SS14-ART-CORE prototypes go in `Resources/Prototypes/_Art`.
- New SS14-ART-CORE locale goes in `Resources/Locale/en-US/_Art`.
