...
description: Naming guidance for SS14-ART-CORE SS14 C#, YAML, FTL, prototypes, components, systems, events, CVars, migrations, and fork-owned serialized types. Use whenever adding new names or reviewing naming consistency.
---
...
- Keep SS14-ART-CORE-specific paths under `_Art`.
