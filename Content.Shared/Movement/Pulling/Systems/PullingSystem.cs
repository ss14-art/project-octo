using Content.Shared._Art.Effects; // ss14-art-edit
using Content.Shared._Art.Movement.Pulling.Components; // ss14-art-edit
using Content.Shared.ActionBlocker;
using Content.Shared.Administration.Logs;
using Content.Shared.Alert;
using Content.Shared.Buckle.Components;
using Content.Shared.CombatMode; // ss14-art-edit
using Content.Shared.Climbing.Components; // ss14-art-edit
using Content.Shared.Climbing.Systems; // ss14-art-edit
using Content.Shared.Cuffs;
using Content.Shared.Cuffs.Components;
using Content.Shared.Database;
using Content.Shared.DragDrop; // ss14-art-edit
using Content.Shared.Effects; // ss14-art-edit
using Content.Shared.Hands;
using Content.Shared.Hands.Components;
using Content.Shared.Hands.EntitySystems;
using Content.Shared.Humanoid; // ss14-art-edit
using Content.Shared.IdentityManagement;
using Content.Shared.Input;
using Content.Shared.Interaction;
using Content.Shared.Interaction.Components; // ss14-art-edit
using Content.Shared.Interaction.Events; // ss14-art-edit
using Content.Shared.Inventory.VirtualItem;
using Content.Shared.Item;
using Content.Shared.Mobs;
using Content.Shared.Mobs.Components; // ss14-art-edit
...
using Content.Shared.Speech.Muting; // ss14-art-edit
using Content.Shared.Standing;
using Content.Shared.Stunnable; // ss14-art-edit
using Content.Shared.Verbs;
using Robust.Shared.Audio.Systems; // ss14-art-edit
...
using Robust.Shared.Random; // ss14-art-edit
using Robust.Shared.Network; // ss14-art-edit
using Robust.Shared.Timing;
using Robust.Shared.Utility;
using System.Numerics; // ss14-art-edit
...
{
    private static readonly TimeSpan BreakAttemptCooldown = TimeSpan.FromSeconds(0.5); // ss14-art-edit
    ...
    private void StopPulling(EntityUid pullableUid, PullableComponent pullableComp)
    {
        ...
        pullableComp.PullerGrabStage = GrabStage.None; // ss14-art-edit
    ...
    public bool CanPull(EntityUid puller, EntityUid pullableUid, PullerComponent? pullerComp = null)
    {
        ...
        if (pullerComp.NeedsHands
            && !pullable.IgnoreNeedsHands // Starlight edit
